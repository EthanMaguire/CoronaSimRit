...
class human:
    ...
    def draw(self):
        ...
        if self.health == 0:
            ...
            if self.testResult == 0 and self.sickTimer / self.sickTime < world.incubationTime:
                pygame.draw.circle(screen, lightred, [posx, posy], radius)
            elif self.testResult == 0:
...
def drawDead():
    message_display("Graveyard", 20, 60, 30, black)
